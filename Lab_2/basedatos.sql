...
INSERT INTO blogs (usuario, fecha, titulo, contenido, imagen)
VALUES (2, '2023-10-21 11:00:00', 'Dota 2', 'Uno de los mejores MOBAS del mundo', NULL);

select * from usuarios;
select * from blogs where usuario = 2;
select * from comentarios;
SELECT comentarios.*, usuarios.nombre AS nombre_usuario
                      FROM comentarios
                      INNER JOIN usuarios ON comentarios.usuario_id = usuarios.id
                      WHERE comentarios.blog_id = 2;

insert into comentarios (blog_id, usuario_id, fecha, contenido)
VALUES (2, 3, '2023-10-21 15:00:00', 'concuerdo, es una buena seria fuera de lo clasico y cliche')
